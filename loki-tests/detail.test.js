...
describe('Product Detail Page Visual Regression', () => {
  const url = 'http://127.0.0.1:5000/product/1';
  const basePath = path.join('loki_snapshots', 'base', 'detail.png');
  const newPath = path.join('loki_snapshots', 'detail.png');
  const diffPath = path.join('loki_snapshots', 'diff', 'detail-diff.png');
