...
describe('Login Page Visual Regression', () => {
  ...
  const basePath = path.join('loki_snapshots', 'base', 'login.png');
  const newPath = path.join('loki_snapshots', 'login.png');
  const diffPath = path.join('loki_snapshots', 'diff', 'login-diff.png');
